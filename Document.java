...
public class Document{
    ...
    public Document clonedDoc() {
        return new Document(this.id, this.name, this.state, this.productionDate, this.modifyDateTime);
    }
...
// test
    ...
    //     clonedDoc.setState("Completato");
    //     System.out.println("Modifiche al documento copiato: " + clonedDoc);
    //     System.out.println("Documento originale: " + doc);
    // }
}
